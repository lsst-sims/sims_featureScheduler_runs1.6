...
from lsst.sims.featureScheduler.utils import standard_goals, NES_healpixels, ra_dec_hp_map, magellanic_clouds_healpixels
...
if __name__ == "__main__":
    ...
    footprints = combo_dust_fp(nside=nside)
    ...
    greedy_fps = greedy_footprints(nside=nside)
    greedy = gen_greedy_surveys(nside, nexp=nexp, footprints=greedy_fps)

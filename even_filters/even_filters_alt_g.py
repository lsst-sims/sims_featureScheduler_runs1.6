...
def gen_greedy_surveys(nside=32, nexp=1, exptime=30., filters=['i', 'z', 'y'],
                       ...
                       stayfilter_weight=3., footprints=None, roll_weight=3.):
    """
...
def generate_blobs(nside, nexp=1, exptime=30., filter1s=['u', 'u', 'g', 'r', 'i', 'z', 'y'],
    ...
    wfd_halves = wfd_half()
    # For the m5 depth, use r m5 for r and redder
    filter_translate = {'u': 'u', 'g': 'r', 'r': 'r', 'i': 'r', 'z': 'r', 'y': 'r'}
    ...
    for filtername, filtername2 in zip(filter1s, filter2s):
        ...
        if filtername2 is not None:
            bfs.append((bf.M5_diff_basis_function(filtername=filter_translate[filtername], nside=nside), m5_weight/2.))
            bfs.append((bf.M5_diff_basis_function(filtername=filter_translate[filtername2], nside=nside), m5_weight/2.))

        else:
            bfs.append((bf.M5_diff_basis_function(filtername=filter_translate[filtername], nside=nside), m5_weight))
